                    ...
                    <div>
                        ...
                        <form className="grid grid-cols-1 lg:grid-cols-2 gap-2">
                            <input
                                ...
                                onChange={handleChange}
                                readOnly={!isEditing}
                                className="h-9 w-full rounded-md border border-neutral-200 bg-transparent px-3 py-1 text-sm transition-colors placeholder:text-black/60 focus-visible:outline-none focus-visible:ring focus-visible:ring-slate-500 disabled:cursor-not-allowed disabled:opacity-50"
                            />
                            <input
                                type="tel"
                                name="numberphone"
            ...
            {isEditing && (
                <div className="mt-4">
                    <input
                        ...
                        className="block file:h-9 file:px-4 file:py-2 w-full text-sm text-slate-500 file:mr-4 file:rounded-md file:border-0 file:text-sm file:font-medium file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 file:transition-colors file:focus-visible:outline-1 file:outline-offset-4 file:disabled:pointer-events-none file:disabled:opacity-50 cursor-pointer"
                    />
                </div>
            )}
